...
class MoreDetailsPage2 extends StatelessWidget {
  const MoreDetailsPage2({Key? key}) : super(key: key);
                  ...
                  Row(
                    children: [
                      ...
                      const Expanded(
                        child: Center(
                          child: Text(
                            'Details about DR. D. T. N Ariyapala',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 18.0,
                        ...
                        children: [
                          ...
                          const Column(
                            ...
                            children: [
                              ...
                              Text(
                                ' Dentist at peradeniya medical hospital',
                                style: TextStyle(
                                  fontSize: 12.0,
                                ),
                              ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Professor & Ex Head of Department at dental surgery unit, Peradeniya Medical College & Hospital',
                        style: TextStyle(
                      ...
                      Text(
                        'Has tons of experience in dental surgery specialization.Specially trained to take care of the teeth, gums, and mouth, helping to maintain and improve a persons overall oral hygiene and health',
                        style: TextStyle(
                            fontSize: 14.0, fontFamily: "RedHatDisplay"),
                      ),
                      SizedBox(
