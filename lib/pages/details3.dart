...
class MoreDetailsPage3 extends StatelessWidget {
  const MoreDetailsPage3({Key? key}) : super(key: key);
                  ...
                  Row(
                    children: [
                      ...
                      const Expanded(
                        child: Center(
                          child: Text(
                            'Details about DR. Manjula Kuruppu',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 18.0,
                        ...
                        children: [
                          ...
                          const Column(
                            ...
                            children: [
                              ...
                              Text(
                                ' Ex Counselor at Kalubowila hospital',
                                style: TextStyle(
                                  fontSize: 12.0,
                                ),
                              ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Professor & Ex Head of Department at Psycology Department, Kandy Medical College & Hospital',
                        style: TextStyle(
                      ...
                      Text(
                        'licensed professional who provides support, guidance, and assistance to peoples facing a variety of personal, emotional or psychological challenges. primary role is to help people explore their thoughts and feelings ',
                        style: TextStyle(
                            fontSize: 14.0, fontFamily: "RedHatDisplay"),
                      ),
                      SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const FeedbackPage3()),
                      );
                    },
