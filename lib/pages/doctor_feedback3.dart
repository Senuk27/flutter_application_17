...
class FeedbackPage3 extends StatefulWidget {
  const FeedbackPage3({Key? key}) : super(key: key);

  @override
  _FeedbackPage3State createState() => _FeedbackPage3State();
}

class _FeedbackPage3State extends State<FeedbackPage3> {
                    ...
                    Container(
                      ...
                      child: const Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            'Would you recommend DR.Manjula Kuruppu\nto your friend?',
                            style: TextStyle(
                              fontSize: 16.0,
                              fontFamily: 'RedHatDisplay',
                              color: Color.fromARGB(255, 94, 94, 97),
